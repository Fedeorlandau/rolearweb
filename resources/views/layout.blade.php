...
<body>
	...
	<div class="limiter">
		...
		<div class="bounce-in-top">
			...
			<form class="login100-form validate-form">
					...
					<hr style="border: 0;height: 1px;background-image: linear-gradient(to right, rgba(0, 0, 0, 0), rgba(179, 179, 179, 0.75), rgba(0, 0, 0, 0));">
  ...
  <footer id="sticky-footer" class="py-4 bg-dark text-white-50">
    <div class="container text-center">
        <small><a href="#"> &nbsp;&nbsp; <a href="#"><i class="fab fa-discord"></i> Robert#9999</a> &nbsp;&nbsp; <a href="https://rgamez.net"><i class="fas fa-server"></i> Necesito esta mitigación DDOS</a> &nbsp;&nbsp; <!-- - Tu IP: --> <?= "";//getUserIP();?></small>
    </div>
  </footer>
